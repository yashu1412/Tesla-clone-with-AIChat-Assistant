    ...
    const fetchAdapters = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/Adapters`
        );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Explore our premium adapters for seamless compatibility with your Tesla charging ecosystem.
            </p>
          </motion.div>
          ...
          {!loading && !error && products.length === 0 && (
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              <h3 className="text-xl text-gray-600">
                No adapters available at the moment
              </h3>
              <button
                onClick={() => navigate('/Tesla-shop')}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Works across multiple charging standards
                  </p>
                </div>

                <div className="p-4">
                  <h3 className="font-medium mb-2">Compact & Portable</h3>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="p-4">
                  <h3 className="font-medium mb-2">Safe Power Transfer</h3>
                  <p className="text-gray-600 text-sm">
                    Certified protection for voltage and heat
                  </p>
                </div>
              </div>
            </motion.div>
