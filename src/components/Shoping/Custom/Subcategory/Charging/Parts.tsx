    ...
    const fetchParts = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/Parts`
        );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Discover genuine Tesla parts engineered for precision, performance, and durability.
            </p>
          </motion.div>
          ...
          {!loading && !error && products.length > 0 && (
            ...
            >
              <h2 className="text-2xl font-semibold mb-6 text-center">
                Why Choose Genuine Tesla Parts?
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div className="p-4">
                  <h3 className="font-medium mb-2">Long-Lasting Quality</h3>
                  <p className="text-gray-600 text-sm">
                    Built for maximum durability and safety
                  </p>
                </div>

                <div className="p-4">
                  <h3 className="font-medium mb-2">Factory Certified</h3>
                  <p className="text-gray-600 text-sm">
                    Original OEM-certified Tesla parts
                  </p>
                </div>
              </div>
            </motion.div>
