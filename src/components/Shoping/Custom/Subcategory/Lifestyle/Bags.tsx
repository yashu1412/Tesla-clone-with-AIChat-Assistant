...
const Bags: React.FC = () => {
    ...
    const fetchBags = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/Bags`
        );
        ...
        setError('An error occurred while fetching bags');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleAddToCart = (product: Product) => {
    addToCart({
      id: product.id,
      name: product.name,
      price: product.price, // keep as string to match addToCart signature
      image: product.image,
      quantity: 1
    });
    ...
    <>
      ...
      <div className="pt-24 px-4 md:px-8 min-h-screen bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-semibold mb-3">Tesla Bags</h1>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Explore our premium range of Tesla travel and utility bags.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Premium Material</h3>
                  <p className="text-gray-600 text-sm">
                    Built with durable high-quality fabric
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Global Style</h3>
                  <p className="text-gray-600 text-sm">
                    Modern design trusted worldwide
                  </p>
                </div>
              </div>
            </motion.div>
