    ...
    const fetchBestSellers = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/BestSellers`
        );
        ...
        setError('An error occurred while fetching best sellers');
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Discover our most popular and top-rated Tesla accessories.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Top Rated</h3>
                  <p className="text-gray-600 text-sm">
                    Loved by thousands of Tesla owners
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Quality Verified</h3>
                  <p className="text-gray-600 text-sm">
