    ...
    const fetchGiftCard = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/GiftCard`
        );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Choose the perfect Tesla gift card for your friends or family.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Perfect Gift</h3>
                  <p className="text-gray-600 text-sm">
                    Surprise your loved ones with a Tesla experience
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Flexible Value</h3>
                  <p className="text-gray-600 text-sm">
                    Choose the amount that fits your gift
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium mb-2">Redeem Worldwide</h3>
                  <p className="text-gray-600 text-sm">
                    Usable at Tesla shops and online
                  </p>
                </div>
              </div>
            </motion.div>
