...
interface Product {
  id: string;
  name: string;
  price: string; // backend sending string
  description: string;
  category: string;
  subcategory: string;
  image: string;
    ...
    const fetchKids = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/Kids`
        );
        ...
        setError('An error occurred while fetching kids products');
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Explore fun, safe, and premium products designed spécialement for kids.
            </p>
          </motion.div>
