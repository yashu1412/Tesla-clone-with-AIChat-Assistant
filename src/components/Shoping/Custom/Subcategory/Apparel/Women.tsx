    ...
    const fetchWomenProducts = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/product/subcategory/Women`
        );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Explore our premium women’s fashion collection designed for elegance, comfort, and modern lifestyle.
            </p>
          </motion.div>
          ...
          {!loading && !error && products.length === 0 && (
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              <h3 className="text-xl text-gray-600">
                No women products available at the moment
              </h3>
              <button
                onClick={() => navigate('/Tesla-shop')}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Crafted using high-grade materials
                  </p>
                </div>

                <div className="p-4">
                  <h3 className="font-medium mb-2">Modern Designs</h3>
                  <p className="text-gray-600 text-sm">
                    Trend-inspired and elegant styles
                  </p>
                </div>

                <div className="p-4">
                  <h3 className="font-medium mb-2">Comfort Guaranteed</h3>
                  <p className="text-gray-600 text-sm">
