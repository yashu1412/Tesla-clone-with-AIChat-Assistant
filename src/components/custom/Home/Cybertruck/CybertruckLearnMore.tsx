...
<section className="relative h-screen flex flex-col items-center justify-center bg-white">
  ...
  <div className="w-full text-center mt-12 px-4 md:px-0 max-w-[1900px]">
    ...
    <p className="text-gray-600 text-base font-semibold md:text-2xl max-w-7xl mx-auto leading-relaxed">
    ...
    <div className="mt-6 flex flex-col items-center gap-2">
      ...
      <p className="text-3xl font-semibold">Overall NHTSA Safety Rating</p>
    </div>
  </div>
</section>
...
<div className="bg-[#161616] text-white">
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center px-6 pb-20">
    {/* Item 1 */}
    <div>
      <h3 className="text-4xl font-bold">3 <span className="font-normal">Days</span></h3>
    ...
    {/* Item 2 */}
    <div>
      <h3 className="text-4xl font-bold">240<span className="text-lg ml-1">v</span></h3>
      <p className="mt-2 text-gray-300 text-sm font-medium">
    ...
    {/* Item 3 */}
    <div>
      <h3 className="text-4xl font-bold">5 <span className="font-normal">Outlets</span></h3>
      <p className="mt-2 text-gray-300 text-sm font-medium">
...
<div className="min-h-screen bg-black text-white px-4 md:px-8 py-12">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <h1 className="text-3xl md:text-5xl font-semibold mb-10">Cybertruck Specs</h1>

        {/* Drive & Performance Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-medium mb-8">Performance</h2>
        ...
        <div className="mb-16 border-t border-gray-800 pt-16">
          <h2 className="text-3xl font-medium mb-8">Dimensions</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-4">
            <div>
        ...
        {/* Charging Section */}
        <div className="mb-16 border-t border-gray-800 pt-16">
          <h2 className="text-3xl font-medium mb-8">Charging</h2>
        ...
        {/* Warranty Section */}
        <div className="mb-16 border-t border-gray-800 pt-16">
          <h2 className="text-3xl font-medium mb-8">Warranty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-4">
            <div>
