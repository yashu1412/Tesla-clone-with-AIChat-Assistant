...
function ModelYLearnMore() {
  ...
  const videoData = [
    {
      src: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto:best/Model-X-Interior-Carousel-1-Cinematic-Display-Desktop-Global.mp4",
    ...
    {
      src: "https://digitalassets.tesla.com/tesla-contents/video/upload/Model-X-Interior-Carousel-2-Yoke-Steering-Desktop.mp4",
      title: "Yoke Steering",
      description: "A bold new approach to steering offers better feel and an unobstructed view of the road ahead. Tap the brake and Model X automatically selects the correct direction to start your trip."
    },
    {
      src: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto:best/Model-X-Interior-Carousel-3-Perfect-Environment-Desktop.mp4",
      title: "Performance Redefined",
      description: "Experience lightning-fast acceleration with dual motor all-wheel drive and adaptive air suspension."
    },
    {
      src: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto:best/Model-X-Interior-Carousel-4-Spacious-Cabin-Desktop.mp4",
      title: "Spacious Cabin",
      description: "Model X offers a spacious cabin with the world's largest panoramic windshield and seating for up to seven."
    },
    {
  ...
  const videoFeatureData = [
    ...
    },
    {
      ...
      video: "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto:best/lane_change_0-mp4.mp4",
    },
    {
      title: 'Dumb Summon',
      description:
...
<div className="flex flex-col md:flex-row items-center justify-center h-screen bg-white text-black px-6">
  ...
  <div className="w-full md:w-1/2 flex justify-center mt-8 md:mt-0">
    <div className="relative max-w-3xl w-full overflow-hidden rounded-lg shadow-2xl">
      <img
        src="https://digitalassets.tesla.com/discovery-tesla-com/image/upload/f_auto,q_auto/TD_Component_MX_Desktop.jpg" // Replace with your actual Tesla image
        alt="Tesla Model 3"
        className="w-full h-full object-cover"
      />
    </div>
      ...
      <div className="mt-10 w-full max-w-6xl mx-auto px-6">
        ...
        <div className="relative w-full h-screen">
              {/* Background Image */}
              <img 
                src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Model-X-End-of-Page-Desktop.jpg"
                alt="Tesla Model X" 
                className="w-full h-full object-cover"
              />
              ...
              <div className="absolute top-[80%] w-full text-center">
                <h1 className="text-3xl font-semibold text-white">Model X</h1>
