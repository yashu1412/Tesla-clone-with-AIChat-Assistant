...
const AdminNavbar: React.FC = () => {
  return (
    <nav className="bg-black text-white px-3 sm:px-6 py-3 sm:py-4 shadow-md flex items-center justify-between w-screen overflow-x-hidden">
      ...
      <ul className="flex items-center gap-3 sm:gap-6 text-[13px] sm:text-sm uppercase tracking-wider overflow-x-auto whitespace-nowrap">
