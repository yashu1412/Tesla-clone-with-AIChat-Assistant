 ...
 User question: ${userMessage}`
  ...
  return (
    <div className="min-h-screen bg-white text-black flex flex-col overflow-hidden">
      ...
      <div className="bg-black text-white shadow-md animate-fade-in">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link 
              to="/"
              className="p-2 rounded-full hover:bg-white/20 transition-colors hover:scale-110 transition-transform duration-300"
            >
              <ArrowLeft className="w-5 h-5" />
            </Link>
            <div className="flex items-center gap-2">
              <Bot className="w-6 h-6 animate-pulse" />
              <h1 className="font-medium text-xl">Tesla Assistant</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-3xl w-full mx-auto p-4 flex flex-col animate-fade-in">
        <div className="bg-white border border-black/20 rounded-xl shadow-xl overflow-hidden flex-1 flex flex-col transform transition-all duration-500 hover:shadow-2xl">
          {/* Messages Container */}
            ...
            {messages.map((message, index) => (
              <div
                ...
                style={{
                  ...
                  opacity: 1 // Changed from 0 to 1 to make messages visible
                }}
              >
                <div
                ...
                >
                  <p className="font-medium">{message.text}</p> {/* Added font-medium for better visibility */}
                  <div
          ...
          <div className="p-4 border-t border-black/10 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center gap-2">
              <Input
                ref={inputRef}
                value={input}
